...
const baseStyles = {
  solid:
    'inline-flex justify-center rounded-md py-1 px-4 text-sm sm:text-base font-medium tracking-tight shadow-sm focus:outline-none pointer-cursor hover:contrast-125 transition duration-300 ease-in-out',
  outline:
    'inline-flex justify-center rounded-md border py-[calc(theme(spacing.1)-1px)] px-[calc(theme(spacing.4)-1px)] text-base font-medium tracking-tight focus:outline-none',
}

const variantStyles = {
  solid: {
    primary:
      'bg-primary text-white focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary active:text-white/80 disabled:opacity-30 disabled:hover:bg-primary',
  ...
  outline: {
    primary:
      'border-slate-200 text-primary hover:border-slate-300 hover:bg-slate-50 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-slate-600 active:border-slate-200 active:bg-slate-50 active:text-primary/70 disabled:opacity-40 disabled:hover:border-slate-200 disabled:hover:bg-transparent',
